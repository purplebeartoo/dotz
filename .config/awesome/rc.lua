...
beautiful.init(gears.filesystem.get_configuration_dir() .. "cktheme.lua")
...
terminal = "alacritty"
editor = os.getenv("EDITOR") or "alacritty"
...
-- My Bindings
    ...
    awful.key({ modkey, "Shift"   }, "q", function () awful.util.spawn_with_shell("pkill -KILL -u ck") end,
...
client.connect_signal("focus", function(c) c.border_width = "2"
    c.border_color = "#FE0000" end)
-- }}}
