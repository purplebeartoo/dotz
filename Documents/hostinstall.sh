...
#core
sudo pacman -S alsa-utils apparmor base-devel bat brightnessctl btop cmus cronie dconf-editor dunst eza fastfetch fd ffmpeg firefox firejail flatpak fuzzel fzf galculator gcr git gnome-disk-utility gparted grim gvfs handlr hypridle hyprlang hyprlock hyprpaper imagemagick imv inotify-tools keepassxc kitty kvantum kvantum-qt5 libva-mesa-driver libzip linux-headers logrotate man-db meld mesa nemo neovim nm-connection-editor noto-fonts noto-fonts-emoji pam-u2f pavucontrol pciutils perl-image-exiftool playerctl polkit-gnome python-pillow qt5-wayland qt6-wayland ranger reflector ripgrep rsync slurp starship timeshift ttf-dejavu ttf-jetbrains-mono tumbler ufw unzip usbguard usbutils vulkan-radeon waybar wireguard-tools wl-clipboard xdg-desktop-portal-hyprland xdg-desktop-portal-gtk xdg-user-dirs xf86-video-amdgpu zip zsh zsh-autosuggestions zsh-syntax-highlighting
