...
" #ck#
" change gutter_bg, cursor_line, color_col, vertsplit
...
let s:gutter_bg   = { "gui": "#1a1a1a", "cterm": "236" }
let s:gutter_fg   = { "gui": "#919baa", "cterm": "247" }
let s:non_text    = { "gui": "#373C45", "cterm": "239" }

let s:cursor_line = { "gui": "#1a1a1a", "cterm": "237" }
let s:color_col   = { "gui": "#1a1a1a", "cterm": "237" }

let s:selection   = { "gui": "#474e5d", "cterm": "239" }
let s:vertsplit   = { "gui": "#1a1a1a", "cterm": "237" }
