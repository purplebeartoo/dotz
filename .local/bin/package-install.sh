...
paru -S brave-bin bubblejail proton-pass-bin rose-pine-cursor rose-pine-hyprcursor tokyonight-gtk-theme-git waybar-module-pacman-updates-git wezterm-git yaru-colors-icon-theme || {
