#!/usr/bin/env bash
# Run the general use AI inside a Podman container, launches via Ctrl+Numpad 5

set -Eeuo pipefail

# Configuration
DEFAULT_CONTAINER="ollama"
DEFAULT_MODEL="hf.co/unsloth/Qwen3-30B-A3B-Thinking-2507-GGUF:Q3_K_XL"
...
# Launch
echo "Launching the general use AI ($model) in container '$container'..."
